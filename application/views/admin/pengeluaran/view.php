            ...
            <form id="form-add-upd" action="<?= admin_url() ?>pengeluaran/process_save" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="inpkredit" id="inpkredit" onkeydown="return justAngka(event)" onkeyup="javascript:this.value=autoSeparator(this.value);" placeholder="Masukkan debit" />
                        </div>
                    </div>
                    <div class="form-group row">
