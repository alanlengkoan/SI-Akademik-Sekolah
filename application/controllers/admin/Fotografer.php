...
class Fotografer extends MY_Controller
{
    ...
    public function index()
    {
        $data = [
            'halaman' => 'Fotografer',
            'content' => 'admin/fotografer/view',
            'css'     => 'admin/fotografer/css/view',
            'js'      => 'admin/fotografer/js/view'
        ];
        // untuk load view
        $this->load->view('admin/base', $data);
    }

    // untuk get data fotografer by datatable
    public function get_data_fotografer_dt()
    {
        return $this->m_fotografer->getAllDataDt();
    }
    ...
    public function process_save()
    {
        ...
        // data fotografer
        $kurir = [
            'id_fotografer' => acak_id('tb_fotografer', 'id_fotografer'),
            'id_users'      => $users['id_users'],
        ];
        $this->db->trans_start();
        $this->crud->i('tb_users', $users);
        $this->crud->i('tb_fotografer', $kurir);
