...
<script>
    let tabelKategoriDt = null;

    // untuk datatable
    var untukTabelKategori = function() {
        tabelKategoriDt = $('#tabel-kategori').DataTable({
            responsive: true,
            processing: true,
            lengthMenu: [5, 10, 25, 50],
            pageLength: 10,
            ajax: '<?= admin_url() ?>kategori/get_data_kategori_dt',
            columns: [{
                    title: 'No.',
                    data: null,
